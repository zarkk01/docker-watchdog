...
/**
 * VolumesRepository is an interface that help us with executing MYSQL queries on the Volume entity.
 * VolumesRepository does not declare any methods, as it relies on the standard methods provided by JpaRepository
